...
SELECT t.seq,
  ...
  FROM (
        ...
        SELECT 11                          seq, --xdl.source_distribution_type,
                ...
                xte.source_id_int_1,
                xah.ledger_id,
                xah.description xah_desc,
                xal.description xal_desc,
         ...
         WHERE 1 = 1
          ...
          AND xte.entity_code = 'MANUAL'--'EXPENDITURES' --'MTL_ACCOUNTING_EVENTS'
              --improve efficient
           ...
           AND xah.description LIKE '%11000592.SR00023-SG.Manual.3299764'
