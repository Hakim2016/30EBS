/*
For efficiency
add condition t.top_task_id = ppe.proj_element_id
e.g.(TAE0736-TH)
and ppe.proj_element_id=3122306
3413614
*/

/*CURSOR cur_fac_fg IS*/
--Non 'HO - HEA Project FG', non-oversea data
SELECT ei.expenditure_item_id expn_id,
       ...
       --p_cost_type_expd expenditure_type,
 ...
 WHERE 1 = 1
   ...
   AND ei.attribute8 IS NULL
      ...
      --AND ppa.start_date = to_date('20180701','yyyymmdd')
   ...
   AND ppe.proj_element_id = 3122306--3413614 --3122306
