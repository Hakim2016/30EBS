...
SELECT t.seq,
  ...
  FROM (
        ...
        SELECT 10                          seq, --xdl.source_distribution_type,
         ...
         WHERE 1 = 1
           ...
           AND xte.application_id = 275
           AND xte.ledger_id = 2021
           AND xte.entity_id = 15313133
           AND xte.source_id_int_1 = 15313133 --15312121
        ...
        SELECT 11                          seq, --xdl.source_distribution_type,
         ...
         WHERE 1 = 1
           ...
           AND xte.application_id = 275
           AND xte.ledger_id = 2021
           AND xte.entity_id = 15312122 --29932876
           AND xte.source_id_int_1 = 15312122 --15313133--15312121
        
        UNION ALL
        ----999.miscellanous mmt
        SELECT 999                         seq, --xdl.source_distribution_type,
                xah.je_category_name        je_cate, --Subledger Journal Entry
                xe.event_id,
                xect.name                   event_class,
                xet.name                    event_type,
        ...
        UNION ALL
        ----998.miscellanous mmt
        SELECT 998                         seq, --xdl.source_distribution_type,
                xah.je_category_name        je_cate, --Subledger Journal Entry
                xe.event_id,
                xect.name                   event_class,
                xet.name                    event_type,
 ...
 WHERE 1 = 1
   AND t.seq /*NOT*/ IN (998,999)--(4, 5, 6, 7)
      --AND t.seq IN (3,8)
   --AND t.seq = 999--7.5
 ORDER BY t.seq,
          t.event_id,
...
SELECT xte.transaction_number,
 ...
 WHERE 1 = 1
   ...
   AND xe.entity_id = xte.entity_id
   AND xte.ledger_id = 2021
   AND xte.source_id_int_1 = 38434935--38434933--54897910 --54897273-- 54897907--15312121--54897273 --54896869--54868663
      --AND xte.transaction_number LIKE 'HKM18060401%'--54834283
   AND xte.application_id = 707 --275 --200--707
   AND xte.entity_id >= 21516721--29967072
