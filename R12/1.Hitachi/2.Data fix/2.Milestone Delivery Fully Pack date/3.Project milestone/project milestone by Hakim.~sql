SELECT --ROWID,
to_date(t.period_name, 'MON-YY') period,
 t.period_name,
 ...
 WHERE 1 = 1
   ...
   AND t.mfg_no = 'SBC0266-SG'--'SAE0191-SG'--'SBC0256-SG'
   
   AND to_date(period_name, 'MON-YY') IN
       (SELECT MIN(to_date(period_name, 'MON-YY'))
