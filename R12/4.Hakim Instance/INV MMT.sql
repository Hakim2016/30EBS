...
AND mttc.transaction_type_name = 'Case Scrap'
;
...
SELECT * from mtl_transaction_types mttc where 1=1 
AND mttc.TRANSACTION_TYPE_NAME IN ('Case Scrap','Shipping') FOR UPDATE;
