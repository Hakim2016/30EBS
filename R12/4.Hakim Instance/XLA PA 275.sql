...
SELECT *
 ...
 WHERE 1 = 1
   ...
   AND xte.source_id_int_1 = 15312122--15312121
   ;
...
AND gcc.code_combination_id = xal.code_combination_id
   ...
   AND xte.application_id = 707--275
   AND xte.source_id_int_1 = 54868663--15312122--15312121 --15486489--15429305--15312121--15429305
;
...
SELECT *
 ...
 WHERE 1 = 1
   ...
   AND xte.source_id_int_1 = 54868663--54834283--15312121
   ;
...
AND gcc.code_combination_id = xal.code_combination_id
   ...
   AND xah.entity_id = xte.entity_id
   AND xte.application_id = 707
   AND xte.source_id_int_1 IN (54834283,4654211,4654212,4654212) --(4654212) --15486489--15429305--15312121--15429305
ORDER BY xte.source_id_int_1, xal.accounted_dr
;
...
SELECT *
 ...
 WHERE 1 = 1
   ...
   AND xte.source_id_int_1 = 54834283--15312121
   ;
...
AND gcc.code_combination_id = xal.code_combination_id
   ...
   AND xah.entity_id = xte.entity_id
   AND xte.application_id = 200
   AND xte.source_id_int_1 IN (1952272)
ORDER BY xte.source_id_int_1, xal.accounted_dr
;
