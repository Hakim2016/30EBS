SELECT pei.expenditure_item_id   pei_id,
 ...
 WHERE 1 = 1
   ...
   AND pei.burden_cost = -250000--10.15--314.56--324.71
   /*AND pei.expenditure_type  
   LIKE 'Inst21_Labour'*/--'DES Overhead'--'PUR Overhead Transfer'--'%FAC%Wooden%Case%'
   --IN ('FAC - Wooden Case')
...
AND top.task_number IN ('TBK0017-TH', 'TBK0018-TH')--('TAC0473-TH')--('SAC0826-SG')--('SBH0216-PH')--('TAE0736-TH')--('SLS0230-SG','LN0732-L2') --'TAD0021-TH'--mfg
--AND pt.task_number = 'TAD0021-TH.D.11'
AND ppa.segment1 = '21000590'--'21000414'--'203042'--'11001297'--'215110107'--'11001262'--'10101506'--'215110107'--'21000400'--'118010001'--'10101647' --'10202892'--'21000197'--'10101506' --'21000197' --proj_num
