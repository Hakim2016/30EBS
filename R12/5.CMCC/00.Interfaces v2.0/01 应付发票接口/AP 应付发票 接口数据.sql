...
SELECT /*--CAI.ORG_NAME,
 HOU.OPERATING_UNIT,
 CAI.SOURCE_DOCUMENT_NUMBER     报账单号,
 CAI.PROCESS_STATUS_LOOKUP_CODE 头状态,
 CAI.**/
 ...
 CAI.INVOICE_AMOUNT              发票金额,
 CAI.DESCRIPTION                 头摘要
  FROM CUX.CUX_AP_WS_INVOICES_ITF CAI, APPS.CUX_FND_OPERATING_UNITS_V HOU /*,
       CUX.CUX_AP_WS_INVOICE_LINE_ITF CAIL*/
 WHERE 1 = 1
   AND HOU.COMPANY_CODE = CAI.COMPANY_CODE
   AND HOU.OPERATING_UNIT LIKE '%ZJ%'
   ...
   --AND cai.SOURCE_DOCUMENT_NUMBER = '302210E21180926003'
   AND NOT EXISTS (
   SELECT 1/*cai2.PROCESS_STATUS_LOOKUP_CODE*/ from CUX.CUX_AP_WS_INVOICES_ITF CAI2 where 1=1 
   AND cai2.SOURCE_DOCUMENT_NUMBER = /*'302210E21180926003'*/cai.SOURCE_DOCUMENT_NUMBER
   AND cai2.PROCESS_STATUS_LOOKUP_CODE in ('VALIDATED','APPROVAL')
   )
   ;
