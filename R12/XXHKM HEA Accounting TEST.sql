  ...
  FROM (
        ...
        SELECT 11                          seq, --xdl.source_distribution_type,
         ...
         WHERE 1 = 1
           ...
           AND xte.entity_id = 29948464 --29932876
           AND xte.source_id_int_1 = 15320356 --15312122--15313133--15312121
        ...
        SELECT 12                          seq, --xdl.source_distribution_type,
         ...
         WHERE 1 = 1
           ...
           AND xte.application_id = 275
           AND xte.ledger_id = 2021
           AND xte.transaction_number = 'D1808210001'
           AND xte.entity_id = 29948457 --29948464--29932876
        --AND xte.source_id_int_1 = 15320356--15312122--15313133--15312121
        
        ) t
 WHERE 1 = 1
--AND t.seq NOT IN (4,5,6,7)
--AND t.seq IN (3,8)
--AND t.seq = 7.5
 ORDER BY t.seq,
          t.event_id,
...
SELECT xte.transaction_number,
 ...
 WHERE 1 = 1
   ...
   AND xe.entity_id = xte.entity_id
   AND xte.ledger_id = 2021
      --AND xte.source_id_int_1 = 15320356-->=54897910--54897273-- 54897907--15312121--54897273 --54896869--54868663
   AND xte.transaction_number LIKE 'D1808210001' --'HKM18060401%'--54834283
   AND xte.application_id = 275 --707--275 --200--707
   AND xte.entity_id = 29948457 -->= 29948400-->= 29967072
--AND xte.entity_code = 'RCV_ACCOUNTING_EVENTS'
;

--SELECT * FROM fnd_application fa WHERE 1=1 AND fa.appl
