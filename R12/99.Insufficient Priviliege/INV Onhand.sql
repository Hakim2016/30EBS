SELECT msi.segment1,
       ...
       moq.locator_id,
       --apps.inv_project.get_locator(moq.locator_id, moq.organization_id) locator,
 ...
 WHERE moq.organization_id = hou.organization_id
   ...
   AND msi.organization_id = moq.organization_id
      AND moq.organization_id = 350--IO_E_ZJ_302210_浙江省本部 hou
   --AND msi.segment1
      --= 'H-32610372-A'
      --LIKE 'TAE0736-TH%'
...
SELECT *
 ...
 WHERE 1=1
 AND sub.secondary_inventory_name LIKE '301%'
...
SELECT * from apps.hr_organization_units hou where 1=1 
AND hou.name LIKE '%E%302210%';
