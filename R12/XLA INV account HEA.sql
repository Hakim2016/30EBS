SELECT --xah.period_name,
 ...
 WHERE 1 = 1
   ...
   --AND xal.accounting_date BETWEEN to_date('2018-11-01', 'YYYY-MM-DD') AND to_date('2018-11-30', 'YYYY-MM-DD') + 0.99999
   AND xah.ae_header_id = xal.ae_header_id
      --AND xah.period_name = 'MAY-14'
   AND xah.ledger_id = 2021
   AND xah.ledger_id = xte.ledger_id
   AND xah.entity_id = xte.entity_id
   --AND xah.ae_header_id = 34445158
   AND xte.entity_id = 37341370
